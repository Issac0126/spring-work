...
public class SnsBoardController {
	...
	/*
	# 게시글의 이미지 파일 전송 요청
	이 요청은 img 태그의 src 속성을 통해 요청이 들어오고 있다. 
	snsList.jsp 페이지가 로딩되면서 글 목록을 가져오고, JS를 이용해 화면을
	꾸밀 때 img 태그의 src에 작성된 url을 통해 자동으로 요청이 들어오게 된다.
	...
	*/
	...
	public ResponseEntity<byte[]> getFile(@PathVariable String fileLoca, 
		...
		//응답 내용, 응답이 성공했는지에 대한 여부, 응답에 관련된 여러 설정들을 지원한다. 
		...
		try {
			...
			//화면에 전송하고 싶은 값을 headers에 담아서 전달한다.
